...
function creative_store_setup() {
	...
	register_nav_menus( array(
		'menu-1' => esc_html__( 'Primary', 'creative-store' ),
	) );
 ...
 */
function creative_store_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'creative_store_content_width', 640 );
}
add_action( 'after_setup_theme', 'creative_store_content_width', 0 );
...
function creative_store_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'creative-store' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'creative-store' ),
