			...
			<header class="page-header">
				<h1 class="page-title">
					<?php
						...
						elseif ( is_day() ) :
							printf( __( 'Day: %s', 'creative-store' ), '<span>' . get_the_date() . '</span>' );

						elseif ( is_month() ) :
							printf( __( 'Month: %s', 'creative-store' ), '<span>' . get_the_date( 'F Y' ) . '</span>' );

						elseif ( is_year() ) :
							printf( __( 'Year: %s', 'creative-store' ), '<span>' . get_the_date( 'Y' ) . '</span>' );
						...
						elseif ( is_tax( 'post_format', 'post-format-quote' ) ) :
							_e( 'Quotes', 'creative-store' );

						elseif ( is_tax( 'post_format', 'post-format-link' ) ) :
							_e( 'Links', 'creative-store' );
