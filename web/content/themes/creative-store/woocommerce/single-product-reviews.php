...
<div id="reviews">
	<div id="comments">
		<h2><?php
		if ( 'yes' === get_option( 'woocommerce_enable_review_rating' ) && ( $count = $product->get_review_count() ) ) {
	...
	<?php if ( 'no' === get_option( 'woocommerce_review_rating_verification_required' ) || wc_customer_bought_product( '', get_current_user_id(), $product->id ) ) : ?>
